...
import { schedulePricingCheck, seedFromFallbackIfEmpty, checkAndUpdatePricing } from './services/pricingService.js';
...
async function start() {
    try {
        ...
        checkAndUpdatePricing()
            ...
            .catch((err) => console.error('Startup pricing fetch error:', err.message));
