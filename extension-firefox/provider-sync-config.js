...
(function exposeProviderSyncConfig(root) {
  const PROVIDER_COOKIE_DOMAINS = { claude_ai: ['claude.ai', 'www.claude.ai', 'auth.claude.ai', 'api.claude.ai', 'account.anthropic.com'], anthropic_api: ['platform.claude.com', 'www.platform.claude.com'], claude_code: ['platform.claude.com', 'www.platform.claude.com'],     opencode_go: ['opencode.ai', 'www.opencode.ai', 'auth.opencode.ai'],
    opencode_api: ['opencode.ai', 'www.opencode.ai', 'auth.opencode.ai'], zai: ['z.ai', 'www.z.ai'], codex: ['chatgpt.com', 'www.chatgpt.com'], openai_api: ['platform.openai.com', 'www.platform.openai.com'], cline: ['app.cline.bot', 'www.app.cline.bot'] };
